...
class SocialNetworkApp {
	...
	sf::Texture bg_image1, bg_image2, white_logo, blue_logo, blue_button, back_button, post_bg, comment_bg, view_likes_bg;
	sf::Sprite bg_sprite1, bg_sprite2, wlogo_sprite, blogo_sprite, button_sprite, back_button_sprite, post_bg_sprite, comment_bg_sprite, likes_bg_sprite;
	sf::Font font, font1;
	int Choice;
public:
	// Constructor
